...
if (numeroPantalla == 0) {
 ...
 text("Tally Hall: Música Diferente y Creativa", textoX, y, textoAncho, 200);
}
...
//origen
 ...
 text("Tally Hall es una banda de Estados Unidos formada en 2002. Se hicieron conocidos por su estilo original y divertido.", x, height / 2 - 60, textoAncho, 200);
} 
...
//estilo musical
 ...
 text("Su música mezcla rock, pop e indie con sonidos experimentales y letras creativas.", textoX, y, textoAncho, 200);
}
...
//integrantes y corbatitas
 ...
 text("Cada integrante usaba una corbata de distinto color para representar su personalidad dentro de la banda.", textoX, y, textoAncho, 200);
}
...
//albun
 ...
 text("Su álbum más famoso es Marvins Marvelous Mechanical Museum, muy reconocido por su estilo único.", x, height / 2 - 60, textoAncho, 200);
}
...
//cancion conocida
 ...
 text("Canciones como Ruler of Everything y Hidden in the Sand ayudaron a que la banda se vuelva popular en internet. ", textoX, y, textoAncho, 200);
} 
...
//volve tally ;(
 ...
 text("Aunque la banda estuvo inactiva varios años, todavía tiene muchos fans en todo el mundo.", x, height / 2 - 60, textoAncho, 200);
